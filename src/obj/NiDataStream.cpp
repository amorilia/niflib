...
NiDataStream::NiDataStream() : usage((DataStreamUsage)0), access((DataStreamAccess)0), numBytes((unsigned int)0), cloningBehavior((CloningBehavior)0), numRegions((unsigned int)0), numComponents((unsigned int)0), streamable(1) {
...
void NiDataStream::Write( ostream& out, const map<NiObjectRef,unsigned int> & link_map, const NifInfo & info ) const {
...
void NiDataStream::FixLinks( const map<unsigned int,NiObjectRef> & objects, list<unsigned int> & link_stack, const NifInfo & info ) {
